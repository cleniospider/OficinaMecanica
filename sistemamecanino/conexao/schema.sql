...
CREATE TABLE IF NOT EXISTS `clientes` (
  `nome completo` TEXT(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `data_cadastro` TIMESTAMP NULL DEFAULT CURRENT TIMESTAMP,
  `OS_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `estoque_pecas_has_OS` (
  ...
  CONSTRAINT `fk_estoque_pecas_has_OS_OS1`
    FOREIGN KEY (`OS_id` , `OS_veiculo_id1`)
    REFERENCES `OS` (`id` , `veiculo_id1`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Financeiro` (
  ...
  `data` TIMESTAMP NOT NULL DEFAULT CURRENT TIMESTAMP,
