...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if ($stmt_check_os->fetch()) {
            ...
            $stmt_del->execute([$id]);
            header("Location: cadastroveiculo-recep.php?cadastro_sucesso=" . urlencode("Veículo excluído com sucesso!"));
            exit;
        }
    } catch (PDOException $e) {
            ...
            <div class="caixa-exclusao">
                ...
                <form method="POST" class="form-exclusao">
                    ...
                    <div class="botoes-acao-excluir">
                        <a href="cadastroveiculo-recep.php" class="btn-cancelar-exclusao">CANCELAR</a>
