...
<head>
    ...
    <title>Auto Repair - Excluir Veículo (Recepção)</title>
...
<body class="dark-theme">
    ...
    <main class="main-content">
        <div class="veiculo-container">
            <h2 class="titulo-sessao">EXCLUIR VEÍCULO - RECEPÇÃO</h2>

            <div class="caixa-exclusao">
                <div class="icone-alerta">⚠️</div>
                <h3>Tem certeza que deseja excluir este cadastro de veículo?</h3>
                <p class="aviso-texto">Esta ação removerá permanentemente o veículo do sistema.</p>
                
                <form action="cadastroveiculo-recep.html" class="form-exclusao">
                    <div class="botoes-acao-excluir">
                        <a href="cadastroveiculo-recep.html" class="btn-cancelar-exclusao">CANCELAR</a>
