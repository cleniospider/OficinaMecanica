...
<head>
    ...
    <title>Auto Repair - Novo Veículo</title>
            ...
            <div class="caixa-formulario">
                <form action="cadastroveiculo.php" class="form-estilizado">
                    ...
                    <div class="botoes-acao">
                        ...
                        <a href="cadastroveiculo.php" class="btn-voltar">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        if (inputAno) {
            inputAno.addEventListener('input', (e) => {
                // Remove qualquer caractere não numérico instantaneamente
                let value = e.target.value.replace(/\D/g, "");
                
                // Corta o texto para manter o limite de no máximo 4 dígitos
                if (value.length > 4) {
