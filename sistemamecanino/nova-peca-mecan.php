...
<head>
    ...
    <title>Auto Repair - Nova Peça (Mecânico)</title>
        ...
        <div class="container-topo">
            <div class="form-card-dark">
                ...
                <form action="estoque-critico-mecan.php" method="GET">
                    ...
                    <div class="campo-grupo">
                        <label>Preço</label>
                        <input type="number" step="0.01" name="preco" placeholder="Ex: 89,00" required>
                    </div>

                    <div class="campo-grupo">
                        <label>Quantidade</label>
                        <input type="number" name="qtd" placeholder="Ex: 10" required>
                    </div>
