...
// Proteção de sessão para Admin e Recepcionista
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $mecanico_id = null; // Mantido nulo conforme o modelo referenciado
...
<body class="dark-theme">
    ...
    <script>
        ...
        // Cálculo Automático baseado nas peças
        ...
        // Permite limpar o campo para digitação livre
