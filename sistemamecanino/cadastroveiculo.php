...
// 1. Processar Cadastro via POST (vindo de novo-veiculo.php)
...
<head>
    ...
    <title>Auto Repair - Veículos Cadastrados</title>
    ...
    <main class="main-content">
        <div class="orders-container">
                            ...
                            <tr>
                                ...
                                <td data-label="AÇÕES">
                                    <div class="acoes-flex">
                                        <a href="editar-veiculo.php?id=<?= $v['id'] ?>" class="btn-editar" style="background-color: #ff0000; margin-right: 5px;">EDITAR</a>
                                        <a href="excluir-veiculo.php?id=<?= $v['id'] ?>" class="btn-excluir">EXCLUIR</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
            ...
            <div class="area-botao-novo">
                <a href="novo-veiculo.php" class="btn-nova-ordem btn-espacado">+ NOVO VEÍCULO</a>
            </div>
        </div>
    </main>
