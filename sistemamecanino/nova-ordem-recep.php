...
<head>
    ...
    <title>Auto Repair - Nova Ordem (Recepção)</title>
...
<body class="dark-theme">
    ...
    <script>
        ...
        // CORRIGIDO: Selecionando o link da conta de forma mais segura pela classe
        ...
        if(linkConta) {
            linkConta.addEventListener('click', (e) => {
                e.preventDefault(); // Impede a página de navegar e recarregar
        ...
        // --- NOVO SCRIPT: MÁSCARA DE PLACA DE VEÍCULO ---
