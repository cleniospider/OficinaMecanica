...
<head>
    ...
    <title>Auto Repair - Editar Veículo</title>
...
<body>
    ...
    <main class="main-content">
        <div class="container-form-dark">
            <div class="titulo-sessao-container">
                <h2 class="titulo-sessao">EDITAR VEÍCULO <span class="destaque-red">#1025</span></h2>
                ...
                <form action="cadastroveiculo.php" method="POST">
                    ...
                    <div class="form-row">
                        <div class="grupo-input-dark flex-1">
                            ...
                            <input type="text" value="ABC-1234" required style="text-transform: uppercase;">
                        </div>
                        <div class="grupo-input-dark flex-1">
                            <label for="ano-veiculo">ANO</label>
                            <input type="tel" id="ano-veiculo" value="2024" required>
                        </div>
                        <div class="grupo-input-dark flex-1">
                            <label>COR</label>
                            <input type="text" value="Vermelha" required>
                        </div>
                    </div>
    
                    <div class="grupo-input-dark">
                        <label>PROPRIETÁRIO ATUAL</label>
                        <input type="text" name="proprietario" value="Marcos Silva" required>
                    </div>
    
                    <div class="footer-acoes">
                        <button type="submit" class="btn-submit btn-acao btn-salvar-fixo">SALVAR ALTERAÇÕES</button>
                        <a href="cadastroveiculo.php" class="btn-acao btn-voltar-os">VOLTAR</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        // === NOVA LÓGICA: VALIDAÇÃO DO CAMPO ANO (MÁXIMO 4 DÍGITOS NUMÉRICOS) ===
        const inputAno = document.getElementById('ano-veiculo');
        if (inputAno) {
            inputAno.addEventListener('input', (e) => {
                // Remove tudo o que não for número em tempo real
                let value = e.target.value.replace(/\D/g, "");
                
                // Limita o tamanho em 4 caracteres
                if (value.length > 4) {
                    value = value.slice(0, 4);
                }
                
                // Devolve o valor limpo ao campo
