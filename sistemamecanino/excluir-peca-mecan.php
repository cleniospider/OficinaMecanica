...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        // Verificar se a peça já foi usada em alguma OS
        ...
        if ($stmt_check->fetch()) {
            ...
            $stmt_del->execute([$id]);
            header("Location: estoque-critico-mecan.php"); // Volta para a tela de estoque do mecânico
            exit;
        }
...
<head>
    ...
    <title>Auto Repair - Excluir Peça (Mecânico)</title>
            ...
            <div class="caixa-exclusao">
                ...
                <form method="POST" class="form-exclusao">
                    ...
                    <div class="botoes-acao-excluir">
                        <a href="estoque-critico-mecan.php" class="btn-cancelar-exclusao">CANCELAR</a>
